...
describe('Given a Task Repo', () => {
    ...
    describe('When we use load method', () => {
        ...
        test('Then if there are NO DATA, we received a rejected promise', () => {
            global.fetch = jest.fn().mockResolvedValue({
                ok: false,
            });
            expect(async () => {
    ...
    describe('When we use query method', () => {
        ...
        test('Then, if there are NOT id, we received a rejected promise', () => {
            expect(async () => {
                await repo.queryId('');
            }).rejects.toThrowError();
        ...
        test('Then, if the id is NOT VALID, we received a rejected promise', () => {
            global.fetch = jest.fn().mockResolvedValue({
                ok: false,
                status: 404,
    ...
    describe('When we use create method', () => {
        ...
        test(`Then if the data are NOT VALID, we received a rejected promise`, () => {
            global.fetch = jest.fn().mockResolvedValue({
                ok: false,
            });
